...
\begin{table}[H]
    \centering
    \caption{Jacoco кодын хамралтын нэгтгэл}
...
\textit{Тайлбар: Дээрх нийт хамралт нь суурь Fossify кодыг
...
\begin{table}[H]
    \centering
    \caption{Цөм логикийн нарийвчилсан хамралт}
...
Нугалдаг төхөөрөмж болох Samsung Galaxy Z Fold3 дээр
