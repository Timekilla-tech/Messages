...
Програм хангамжийн найдвартай ажиллагааг баталгаажуулахын тулд нэгж туршилт (Unit Test), нэгтгэл туршилт (Integration Test) болон ачааллын туршилт (Stress Test) гэсэн гурван түвшинд шаардлагын \cite{ieee829} дагууд туршилтуудыг гүйцэтгэв. Туршилтыг Android-ийн стандарт \texttt{JUnit} \cite{junit5} болон \texttt{Robolectric} сангуудыг ашиглан автоматжуулсан байдлаар гүйцэтгэсэн.
\section{Кодын хамралтын шинжилгээ (Code Coverage)}

Jacoco \cite{jacoco_report} хэрэгслээр кодын хамралтын шинжилгээ хийсэн үр дүнг
...
70\%-ийн доод шаардлагыг~\cite{ieee830} хангаж байна.
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|l|c|c|}
            ...
            \hline
            org.fossify.messages.ui (хэрэглэгчийн харилцах цонхны логик) & 4\% & 8\% \\
            \hline
...
\begin{itemize}
    ...
    \item \textbf{Үр дүн}: Зурвас ангилах хурд дунджаар 15мс-ээс бага байсан бөгөөд дэлгэц нугалах үед хэрэглэгчийн харилцах цонх гацалтгүйгээр (smooth transition) шилжиж байв.
