...
\begin{figure}[H] \centering \includegraphics[width=0.85\textwidth]{Diagrams/usecase_diagram.drawio} \caption{Системийн хэрэглээний тохиолдлын диаграмм} \label{fig:usecase_diag} \end{figure}
