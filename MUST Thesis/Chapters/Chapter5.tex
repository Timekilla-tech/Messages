...
Системийн хэрэгжүүлэлтийг Android стандарт болон цэвэр кодын зарчимд \cite{clean_code} тулгуурлан гүйцэтгэв. Үндсэн харагдац болон үйлдлүүдийн хэрэгжилтийг дараах хэсгүүдэд хуваан харуулав.
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{|l|l|l|p{6cm}|}
            ...
            \hline
            Програмчлалын хэл & Kotlin \cite{kotlin_programming} (99.9\%) & Java &
...
\end{table}
\subsection{Үндсэн хэрэглэгчийн харилцах цонх}
...
Зурвасуудыг автоматаар ангилахын тулд тогтмол илэрхийлэл болон түлхүүр үгсийг удирдах модулийг хэрэгжүүлсэн. Бөгөөд аппликейшны ар талд (Background) ажиллах шаардлагатай ажлууд, тухайлбал мессежийг товлосон цагт илгээх үйлдлийг найдвартай гүйцэтгэхийн тулд \texttt{WorkManager} \cite{workmanager_docs} санг ашигладаг. Иймд шинээр ирсэн мессеж ч бас аппликейшн хаалттай үед ч автоматаар ангилагдаж, тохирсон шошго оноогддог.
...
Системийн үндсэн сангуудын зохион байгуулалтыг Зураг \ref{fig:file_structure} дээр харуулав.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Figures/project_file_structure.png}
    \caption{Төслийн сангуудын бүтэц}
...
Төслийн хүрээнд Jetpack Compose \cite{jetpack_compose} ашиглан динамик хэрэглэгчийн харилцах цонхнуудыг хэрэгжүүлсэн нь системийн уян хатан байдлыг нэмэгдүүлсэн. Мөн өгөгдлийн сангийн шилжилт болон нугалдаг төхөөрөмжийн тасралтгүй байдлыг кодын түвшинд бүрэн шийдсэн.
