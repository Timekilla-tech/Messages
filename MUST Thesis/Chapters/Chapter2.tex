...
\begin{sidewaysfigure}
    ...
    \begin{ganttchart}[
        ...
        x unit=0.25cm,
        y unit chart=0.8cm,
        title/.style={fill=Chapter, draw=black},
        title label font=\bfseries\small,
        bar/.style={fill=CadetBlue!50, draw=black},
        milestone/.style={fill=OliveGreen, draw=black},
        bar label font=\footnotesize,
        milestone label font=\itshape\scriptsize,
        link/.style={-latex, line width=1pt, black}
    ]{1}{92}
        \gantttitle{2026 оны 3-р сар}{31}
        \gantttitle{2026 оны 4-р сар}{30}
        \gantttitle{2026 оны 5-р сар}{31} \\

% I үе шат: 3-р сарын 4-өөс 3-р сарын 31 (1..31)
        \ganttbar[name=phase1]{I үе шат: Суурь өгөгдлийн сангийн өргөтгөл, Ангиллалт}{4}{31} \\

% II үе шат: 4-р сарын 1-ээс 4-р сарын 28 (32..59)
        \ganttbar[name=phase2]{II үе шат: Хавтас удирдлагын систем ба UI}{20}{59} \\

% III үе шат: 4-р сарын 29-өөс 5-р сарын 19 (60..80)
        \ganttbar[name=phase3]{III үе шат: Нугалдаг дэлгэцийн оновчлол}{50}{80} \\

% IV үе шат: 5-р сарын 20-оос 5-р сарын 31 (81..92)
        \ganttbar[name=phase4]{IV үе шат: Тест ба чанарын баталгаажуулалт}{40}{92} \\



        \ganttlink{phase1}{phase2}
        \ganttlink{phase2}{phase3}
        \ganttlink{phase3}{phase4}
    \end{ganttchart}%
    }
    \caption{Төслийн үе шатуудын Гантт диаграм}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Chart/Timekilla-techCommits.png}
\caption{Төслийн коммитуудын график}
\end{figure}
% ============================================================
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Diagrams/architecture}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{Diagrams/erd}
...
\begin{itemize}
    ...
    \item \textbf{Drafts}: Зурвас бичих хэсэгт бичигдсэн боловч илгээгдээгүй мэдээллийг хадгалдаг хэсэг.
    \item \textbf{Conversations}: Харилцан ярианы ерөнхий мэдээлэл, харилцагч хоорондын зурвасууд.
    \item \textbf{Messages}: Бодит зурвасын агуулга, илгээгч, огноо, харилцан ярианы хамаарал зэрэг хамгийн гол үндсэн их бие болсон өгөгдлийн сангийн бүрдэл.
    \item \textbf{Attachments}: Зурваст хавсаргдсан файлуудын мэдээлэл, жишээ нь зураг, видео гэх мэт.
    \item \texttt{recycle\_bin\_messages}: Устгасан зурвасуудыг түр хадгалах хэсэг, хэрэглэгч устгасан зурвасыг буцааж авах боломжтой.
\end{itemize}
Хамгийн дээд байрлах \texttt{Categories} хүснэгт нь энэхүү төслийн хүрээнд  шинээр нэмсэн бөгөөд үлдсэн хүснэгтүүд нь Fossify  Messages-ийн үндсэн өгөгдлийн сангийн бүрэлдэхүүн хэсэг юм.
...
Мөн харилцан яриан дээр удаан дарснаар гарч ирэх доод хэсгийн тохиргоо гарч ирж тэдгээрээс сонгох явцыг үйл ажиллагааны диаграммаар (Зураг~\ref{fig:long_diag}) дүрслэв. Хавтас оноохоос гадна бусад үндсэн үйлдлүүдийг (архивлах, устгах, уншсан төлөв солих) нэгтгэн харуулсан бөгөөд тэдгээр үйлдэлийг үр дүнг нарийн тайлбарлахгүйгээр үр дүнг төгсгөл хэсэг рүү шууд чиглүүлсэн. Төлөвийн диаграммыг Зураг \ref{fig:long_act}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrams/activity/Long_press}
    \caption{Удаан дарж гарч ирэх туслах цэсний төлвийн диаграмм}
    \label{fig:long_act}
\end{figure}
\section{Төслийн суурь бүтэц (Fossify Messages)}
Fossify Messages (мөн өмнөх Simple Mobile Tools) төслийн сангуудын бүтэц нь Android хөгжүүлэлтийн стандарт болон Separation of Concerns (үүрэг хариуцлагыг тусгаарлах) зарчмыг баримталдаг. Үндсэн хавтаснуудын (Зураг \ref{fig:fossify_structure}) үүргийг доор дэлгэрэнгүй тайлбарлав. Төслийн хүрээнд хийгдэх гол өөрчлөлтүүд нь эдгээр хавтаснуудын дотор шинээр класс үүсгэх, эсвэл одоо байгаа классуудыг өргөтгөх хэлбэрээр явагдах бөгөөд сангуудын ерөнхий бүтэц хадгалагдана.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Figures/project_file_structure}
    \caption{Fossify Messages төслийн сангуудын бүтэц}
    \label{fig:fossify_structure}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{interfaces/ (Abstraction)}: Классууд хоорондоо харилцах гүүр болох "Listener" байрлана. Жишээ нь: \texttt{RefreshMessagesListener} – өгөгдөл өөрчлөгдөхөд UI-г шинэчлэх үүрэгтэй.
...
\begin{itemize}
    \item \textbf{ManageCategoriesActivity}: Ангиллын жагсаалт авах (\texttt{updateCategories}), засах цонх дуудах (\texttt{addOrEditCategory}) үйлдлүүдийг удирдана.
