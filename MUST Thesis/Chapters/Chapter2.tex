...
\subsection{Өгөгдлийн сангийн шинэчлэл (Migration)}
Төслийн хүрээнд \texttt{MessagesDatabase}-ийн хувилбарыг 10-аас 11 болгон ахиулж, дараах өөрчлөлтүүдийг хийсэн:
\begin{itemize}
...
Мөн тогтмол илэрхийллийн шүүлтүүрийн ажиллах дотоод дарааллыг Үйл ажиллагааны диаграммаар (Зураг~\ref{fig:act_diag}) дүрслэв.
...
Аппликейшны дэлгэцүүд болон тэдгээрийн хоорондын харилцан хамаарал, удирдлагын логикийг Зураг~\ref{fig:class_activity}-д үзүүлэв.
...
\begin{itemize}
    ...
    \item \textbf{Local-first Database}: Өгөгдлийн сан нь Android-ийн App Sandbox \cite{room_guide} дотор тусгаарлагдсан тул бусад аппликейшн шууд хандах боломжгүй.
\end{itemize}
